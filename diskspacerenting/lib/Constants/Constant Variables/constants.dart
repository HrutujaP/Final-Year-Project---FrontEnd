...
// const Color kBackgroundStartColorColor.fromARGB(255, 28, 33, 44));
// const Color kBackgroundEndColor = Color(0xFF1F2123);

const Color kSecondaryColor = Color(0xFFFFFFFF);
const Color kTextColor = Color.fromARGB(255, 215, 232, 24);
const Color kDatePickerColor = Color(0xFFa306d);
const Color kContainerStartColor = Color(0xff8ea186);
const Color kContainerMiddleColor = Color(0XFFa3b79a);
const Color kContainerEndColor = Color(0xffe4ddc9);
const Color kBackgroundStartColor = Colors.black;
const Color kBackgroundEndColor = Color(0xff1e453e);
